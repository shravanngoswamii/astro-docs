...
export function remarkCrossReferences() {
	...
	return (tree: Root, file: any) => {
				...
				Object.assign(node, {
					...
					children: [
						...bodyChildren,
						{
							...
							data: {
								hName: "figcaption",
								hProperties: { className: ["docs-figcaption"] },
							},
							children: [
								{
									type: "strong",
									children: [
										{ type: "text", value: `${KIND_LABELS[kind]} ${number}. ` },
									],
								},
		...
		visit(tree, "text", (node: any, index, parent) => {
			...
			const matches = [...node.value.matchAll(refPattern)];
